...
class GoodsSearchController  extends \Controller\Front\Controller
{
    ...
    public function index()
    {
        ...
        if(gd_in_array('state',$goodsConfig['searchType']))
        {
            $goodsStateList = $goods->getGoodsStateList();
            $this->setData('goodsStateList', gd_isset($goodsStateList));
        }
