...
function gd_member_event_fixed_popup(data)
{
    ...
    popupHtml +=
        '<div id="memberEventPopup_'+ data.eventType +'" class="main_popup_layer" style="position: absolute;  z-index: 300; width: 406px; height: 472px; top: '+ data.popupPositionT +'px; left: '+ data.popupPositionL +'px; padding-bottom: 10px;">' +
